"""
Fine-tune Qwen2.5-Coder-7B model on Oracle FastFormula Q&A data using HuggingFace Transformers.

Usage:
    python train_qwen2_5_coder.py --output_dir ./qwen2_5_coder_fastformula_output
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tune Qwen2.5-Coder-7B on FastFormula data")
    parser.add_argument("--model_name", type=str, default="Qwen/Qwen2.5-Coder-7B", help="Model name or path")
    parser.add_argument("--data_path", type=str, default="../data/fastformula", help="Path to training data (file or directory)")
    parser.add_argument("--output_dir", type=str, default="./qwen2_5_coder_fastformula_output", help="Output directory")
...
def main():
    ...
    print("=" * 60)
    print("Qwen2.5-Coder-7B FastFormula Fine-tuning")
    print("=" * 60)
